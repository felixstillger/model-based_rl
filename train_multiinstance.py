...
def main():
    ...
    for check_instance in instance_list_training:
        ...
        s_path=(curr_dir+"/training_checkpoints/cluster_data/training_checkpoints/la_multi_huge/"+instance_str)
    ...
    if train_agent:
        ...
        s_path=curr_dir+'/training_checkpoints/cluster_data/training_checkpoints/la_multi_huge/untrained'
        if not os.path.exists(s_path):
            os.mkdir(s_path)
        ...
        for episode in range(num_episodes):
            for train_instance in instance_list_training:
                ...
                s_path=(curr_dir+"/training_checkpoints/cluster_data/training_checkpoints/la_multi_huge/"+instance_str+"/"+str(episode))
                if not os.path.exists(s_path):
                    os.mkdir(s_path)
                prev_checkpoint=agent.save_checkpoint(s_path)
